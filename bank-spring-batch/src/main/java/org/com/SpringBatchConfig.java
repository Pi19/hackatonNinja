...
import org.com.dao.BankTransaction;
...
public class SpringBatchConfig {
	...
	@Bean
	public FlatFileItemReader<BankTransaction> flateFileItemReader (@Value("${inputFile}")Resource inputFile){
	...
	public LineMapper<BankTransaction> lineMapper(){
		...
		lineTokenizer.setNames("id","account_id","strTransationDate","transactionType","amount");
